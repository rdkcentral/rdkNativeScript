...
include (${JSRUNTIME_SOURCE_DIRECTORY}/jsc_lib/include.cmake)
...
if ( REMOTE_INSPECTOR_ENABLE )
    set (JSRUNTIME_ENGINE_FILES ${JSRUNTIME_ENGINE_FILES}
        ${JSRUNTIME_COMMON_SOURCE_DIRECTORY}/InspectorHTTPServer.cpp)
    add_definitions("-DREMOTE_INSPECTOR_ENABLE")
endif (REMOTE_INSPECTOR_ENABLE )

if (REMOTE_INSPECTOR_ENABLE)
    set(JSRUNTIME_ENGINE_LIBRARIES ${JSRUNTIME_ENGINE_LIBRARIES} -lsoup-3.0)
endif (REMOTE_INSPECTOR_ENABLE)
