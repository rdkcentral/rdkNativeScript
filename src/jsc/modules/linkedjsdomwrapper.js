...
function getRandom(arr) {
    if (!arr || typeof arr.length !== "number") {
        throw new TypeError("crypto.getRandomValues expects an array-like object");
    }
...
const cryptoObj = (typeof globalThis.crypto === "object" && globalThis.crypto) ? globalThis.crypto : {};

if (typeof cryptoObj.getRandomValues !== "function") {
    cryptoObj.getRandomValues = getRandom;
}
if (typeof cryptoObj.randomUUID !== "function") {
    cryptoObj.randomUUID = randomUUIDPolyfill;
}
