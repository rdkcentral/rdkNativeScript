...
const URLSearchParamsDet = require("./URLSearchParams");
const URLSearchParams = URLSearchParamsDet.implementation;

exports.implementation = class URLImpl {
  constructor(constructorArgs) {
    var globalObject = global;
    var url, base;
    if (constructorArgs instanceof Array)
    {
    ...
    this._query = new URLSearchParams(globalObject, [query], { doNotStripQMark: true });
