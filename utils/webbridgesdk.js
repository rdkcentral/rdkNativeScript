...
class ServiceManager {
  ...
  open(conf) {
    ...
    const uri = "ws:" + self._conf.host + ":" + self._conf.port + "/jsonrpc?token="+window.thunder.token();
  ...
  _connectService(service_name) {
    ...
    const service_endpoint = "ws://" + this._conf.host + ":" + this._conf.port + "/Service/" + service_name + "?token=" + window.thunder.token();
